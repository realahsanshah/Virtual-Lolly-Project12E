    ...
    <svg className="lollipop" width="163px" height="431px" viewBox="0 0 163 431" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Lolly">
                ...
                <use className="lollyBottom" fill={fillBottom} fillRule="nonzero" href="#path-1"></use>
                <rect className="lollyTop" fill={fillTop} fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9" width="224" height="134"></rect>
                <rect className="lollyMiddle" fill={fillMiddle} fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113" width="224" height="111"></rect>
